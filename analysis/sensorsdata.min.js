var _ = {},
  sa = {};
sa.para = require("./sensorsdata_conf.js"), sa.status = {}, sa.para.openid_url || (sa.para.openid_url = sa.para.server_url.replace(/\/sa(\.gif){0,1}/, "/mp_login")), "number" != typeof sa.para.send_timeout && (sa.para.send_timeout = 1e3);
...
function e(e, t, r) {
  if (e[t]) {
    ...
    e[t] = "onLaunch" === t ? function() {
      this[sa.para.name] = sa, n.apply(this, arguments), r.apply(this, arguments)
    } : function() {
      n.apply(this, arguments), r.apply(this, arguments)
    }
  } else e[t] = "onLaunch" === t ? function() {
    this[sa.para.name] = sa, r.apply(this, arguments)
  } : function() {
...
function appLaunch(e) {
  ...
  var t = {};
  e && e.path && (t.$url_path = _.getPath(e.path)), _.setShareInfo(e, t);
  var r = _.setUtm(e, t);
  is_first_launch ? (t.$is_first_time = !0, _.isEmptyObject(r.pre1) || sa.setOnceProfile(r.pre1)) : t.$is_first_time = !1, _.isEmptyObject(r.pre2) || sa.registerApp(r.pre2), e.scene = e.scene || "\u672a\u53d6\u5230\u503c", t.$scene = _.getMPScene(e.scene), sa.registerApp({
    $latest_scene: t.$scene
  }), t.$url_query = _.setQuery(e.query), sa.para.autoTrack && sa.para.autoTrack.appLaunch && sa.autoTrackCustom("appLaunch", t, "$MPLaunch")
}

function appShow(e) {
  var t = {};
  mpshow_time = (new Date).getTime(), e && e.path && (t.$url_path = _.getPath(e.path)), _.setShareInfo(e, t);
  var r = _.setUtm(e, t);
  _.isEmptyObject(r.pre2) || sa.registerApp(r.pre2), e.scene = e.scene || "\u672a\u53d6\u5230\u503c", t.$scene = _.getMPScene(e.scene), sa.registerApp({
    $latest_scene: t.$scene
  }), t.$url_query = _.setQuery(e.query), sa.para.autoTrack && sa.para.autoTrack.appShow && sa.autoTrackCustom("appShow", t, "$MPShow")
}

function appHide() {
  var e = (new Date).getTime(),
    t = {};
  t.$url_path = _.getCurrentPath(), mpshow_time && e - mpshow_time > 0 && (e - mpshow_time) / 36e5 < 24 && (t.event_duration = (e - mpshow_time) / 1e3), sa.para.autoTrack && sa.para.autoTrack.appHide && sa.autoTrackCustom("appHide", t, "$MPHide")
}
...
function pageOnload(e) {
  if (e && _.isObject(e)) {
    ...
    var n = _.getUtm(t, "$", "$latest_");
    this.sensors_mp_load_utm = n.pre1, this.sensors_mp_url_query = _.setQuery(e)
  }
}
...
function pageOnshow() {
  ...
  var t = {};
  t.$referrer = sa_referrer, t.$url_path = e, sa.status.last_referrer = sa_referrer, this.sensors_mp_load_utm && (_.extend(t, this.sensors_mp_load_utm), this.sensors_mp_load_utm = null), this.sensors_mp_url_query && (t.$url_query = this.sensors_mp_url_query, this.sensors_mp_url_query = ""), sa.para.onshow ? sa.para.onshow(sa, e, this) : sa.autoTrackCustom("pageShow", t, "$MPViewScreen"), sa_referrer = e, sa.status.referrer = e
}

function pageOnshare(e) {
  ...
  e.onShareAppMessage = function() {
    ...
    return sa.para.allow_amend_share_path && ("object" != typeof e && ((e = {}).path = _.getCurrentPath()), "object" != typeof e || void 0 !== e.path && "" !== e.path || (e.path = _.getCurrentPath()), "object" == typeof e && "string" == typeof e.path && (-1 === e.path.indexOf("?") ? e.path = e.path + "?" : "&" !== e.path.slice(-1) && (e.path = e.path + "&")), e.path = e.path + "sampshare=" + encodeURIComponent(_.getShareInfo())), e
  }
}
if (logger.info = function() {
      ...
      s = _.each = function(t, r, s) {
        ...
        if (e && t.forEach === e) t.forEach(r, s);
          ...
          for (var a = 0, i = t.length; a < i; a++)
            if (a in t && r.call(s, t[a], a, t) === n) return !1
        } else
          for (var o in t)
            if (hasOwnProperty.call(t, o) && r.call(s, t[o], o, t) === n) return !1
      };
    _.logger = logger, _.extend = function(e) {
      ...
      var a = !1;
      return null == e ? a : t && e.indexOf === t ? -1 != e.indexOf(r) : (s(e, function(e) {
        if (a || (a = e === r)) return n
      }), a)
    }
  }(), _.trim = function(e) {
    ...
    for (var t, r = [], n = {}, s = 0; s < e.length; s++)(t = e[s]) in n || (n[t] = !0, r.push(t));
    return r
    ...
    var t, r, n, s, a, i = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",
      o = 0,
      c = 0,
      u = "",
      p = [];
    ...
    e = _.utf8Encode(e);
    do {
      t = (a = e.charCodeAt(o++) << 16 | e.charCodeAt(o++) << 8 | e.charCodeAt(o++)) >> 18 & 63, r = a >> 12 & 63, n = a >> 6 & 63, s = 63 & a, p[c++] = i.charAt(t) + i.charAt(r) + i.charAt(n) + i.charAt(s)
    } while (o < e.length);
    ...
    var r = source_channel_standard.split(" "),
      n = source_channel_standard.split(" "),
      s = "",
      a = {};
    return 2 !== (e = e.split("?")).length ? {} : (e = "?" + (e = e[1]), _.isArray(sa.para.source_channel) && sa.para.source_channel.length > 0 && (n = n.concat(sa.para.source_channel), n = _.unique(n)), _.each(n, function(t) {
      s = _.getQueryParam(e, t), (s = _.decodeURIComponent(s)).length && _.include(r, t) && (a[t] = s)
    }), a)
    ...
    var n = (r = JSON.parse(r)).d,
      s = r.p,
      a = r.i;
    "string" == typeof a ? (t.$share_distinct_id = a, share_distinct_id = a) : t.$share_distinct_id = "\u53d6\u503c\u5f02\u5e38", "number" == typeof n ? (t.$share_depth = n, share_depth = n) : t.$share_depth = "\u53d6\u503c\u5f02\u5e38", t.$share_url_path = "string" == typeof s ? s : "\u53d6\u503c\u5f02\u5e38"
    ...
    if (e && _.isObject(e.query)) {
      var n = (r = _.extend({}, e.query)).scene;
      n && (n = -1 !== (n = _.decodeURIComponent(n)).indexOf("?") ? "?" + n.replace(/\?/g, "") : "?" + n, _.extend(r, _.getObjFromQuery(n))), e.query.q && _.extend(r, _.getObjFromQuery(_.decodeURIComponent(e.query.q)))
    }
    ...
    var a = _.getUtm(r, "$", "$latest_");
    return _.extend(t, a.pre1), a
  }, _.info = {
    properties: {
      $lib: LIB_NAME,
    ...
    set: function(e, t) {
      var r = {};
      for (var n in "string" == typeof e ? r[e] = t : "object" == typeof e && (r = e), this._state = this._state || {}, r) this._state[n] = r[n];
      this.save()
    },
    change: function(e, t) {
      this._state[e] = t
    ...
    var t = "";
    e._nocache = (String(Math.random()) + String(Math.random()) + String(Math.random())).slice(2, 15), logger.info(e), e = JSON.stringify(e), t = -1 !== sa.para.server_url.indexOf("?") ? sa.para.server_url + "&data=" + encodeURIComponent(_.base64Encode(e)) : sa.para.server_url + "?data=" + encodeURIComponent(_.base64Encode(e));
    ...
    var n = sa.para.autoTrack[e],
      s = "";
    sa.para.autoTrack && n && ("function" == typeof n ? (s = n(), _.isObject(s) && _.extend(t, s)) : _.isObject(n) && (_.extend(t, n), sa.para.autoTrack[e] = !0), sa.track(r, t))
    ...
    return ""
  }, sa.para.is_plugin) sa.App = function(t) {
  e(t = t || {}, "onLaunch", appLaunch), e(t, "onShow", appShow), e(t, "onHide", appHide), App.apply(this, arguments)
}, sa.Page = function(t) {
  e(t, "onLoad", pageOnload), e(t, "onShow", pageOnshow), "function" == typeof t.onShareAppMessage && pageOnshare(t), Page.apply(this, arguments)
};
else if (!1 !== sa.para.autoTrack) {
  var oldApp = App;
  App = function(t) {
    e(t, "onLaunch", appLaunch), e(t, "onShow", appShow), e(t, "onHide", appHide), oldApp.apply(this, arguments)
  };
  var oldPage = Page;
  Page = function(t) {
    e(t, "onLoad", pageOnload), e(t, "onShow", pageOnshow), "function" == typeof t.onShareAppMessage && pageOnshare(t), oldPage.apply(this, arguments)
  }
}
